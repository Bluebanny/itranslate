...
document.querySelector("#start").onmousedown = () => {
...
document.querySelector("#start").onmouseup = () => {
...
recognition.onresult = function (event) {
  ...
  let sourceLang = "FR"; // Replace with your source language code
  let targetLang = "EN"; // Replace with your target language code
